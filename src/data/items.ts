...
export const items: Record<string, Item> = {
  ...
  "Glass War Axe": { enchantPoints: 3, slot: "Weapon", icon: "/icons/items/Glass_War_Axe.png" },
  "Ebony War Axe": { enchantPoints: 10, slot: "Weapon", icon: "/icons/items/Ebony_War_Axe.png" },
  "Daedric War Axe": { enchantPoints: 15, slot: "Weapon", icon: "/icons/items/Daedric_War_Axe.png" },
  "Miner's Pick": { enchantPoints: 1, slot: "Weapon", icon: "/icons/items/Miner's_Pick.png" },
  "Iron Battle Axe": { enchantPoints: 5.5, slot: "Weapon", icon: "/icons/items/Iron_Battle_Axe.png" },
  "Nordic Battle Axe": { enchantPoints: 5.5, slot: "Weapon", icon: "/icons/items/Nordic_Battle_Axe.png" },
  "Steel Battle Axe": { enchantPoints: 5.5, slot: "Weapon", icon: "/icons/items/Steel_Battle_Axe.png" },
  "Dwarven Battle Axe": { enchantPoints: 5.5, slot: "Weapon", icon: "/icons/items/Dwarven_Battle_Axe.png" },
  "Orcish Battle Axe": { enchantPoints: 8, slot: "Weapon", icon: "/icons/items/Orcish_Battle_Axe.png" },
  "Daedric Battle Axe": { enchantPoints: 16.5, slot: "Weapon", icon: "/icons/items/Daedric_Battle_Axe.png" },
  "Chitin Club": { enchantPoints: 2, slot: "Weapon", icon: "/icons/items/Chitin_Club.png" },
  "Iron Club": { enchantPoints: 4, slot: "Weapon", icon: "/icons/items/Iron_Club.png" },
  "Steel Club": { enchantPoints: 4, slot: "Weapon", icon: "/icons/items/Steel_Club.png" },
  "Spiked Club": { enchantPoints: 4, slot: "Weapon", icon: "/icons/items/Spiked_Club.png" },
  "Dreugh Club": { enchantPoints: 3.6, slot: "Weapon", icon: "/icons/items/Dreugh_Club.png" },
  "Daedric Club": { enchantPoints: 12, slot: "Weapon", icon: "/icons/items/Daedric_Club.png" },
  "Iron Mace": { enchantPoints: 5, slot: "Weapon", icon: "/icons/items/Iron_Mace.png" },
  "Steel Mace": { enchantPoints: 5, slot: "Weapon", icon: "/icons/items/Steel_Mace.png" },
  "Dwarven Mace": { enchantPoints: 5, slot: "Weapon", icon: "/icons/items/Dwarven_Mace.png" },
  "Ebony Mace": { enchantPoints: 10, slot: "Weapon", icon: "/icons/items/Ebony_Mace.png" },
  "Daedric Mace": { enchantPoints: 15, slot: "Weapon", icon: "/icons/items/Daedric_Mace.png" },
  "Iron Warhammer": { enchantPoints: 5.5, slot: "Weapon", icon: "/icons/items/Iron_Warhammer.png" },
  "Steel Warhammer": { enchantPoints: 5.5, slot: "Weapon", icon: "/icons/items/Steel_Warhammer.png" },
  "Dwarven Warhammer": { enchantPoints: 5.5, slot: "Weapon", icon: "/icons/items/Dwarven_Warhammer.png" },
  "Orc Warhammer": { enchantPoints: 6.6, slot: "Weapon", icon: "/icons/items/Orc_Warhammer.png" },
  "Sixth House Bell Hammer": { enchantPoints: 10.5, slot: "Weapon", icon: "/icons/items/Sixth_House_Bell_Hammer.png" },
  "Daedric Warhammer": { enchantPoints: 16.5, slot: "Weapon", icon: "/icons/items/Daedric_Warhammer.png" },
  "Wooden Staff": { enchantPoints: 7, slot: "Weapon", icon: "/icons/items/Wooden_Staff.png" },
  "Steel Staff": { enchantPoints: 7, slot: "Weapon", icon: "/icons/items/Steel_Staff.png" },
  "Silver Staff": { enchantPoints: 5.6, slot: "Weapon", icon: "/icons/items/Silver_Staff.png" },
  "Dreugh Staff": { enchantPoints: 6.3, slot: "Weapon", icon: "/icons/items/Dreugh_Staff.png" },
  "Glass Staff": { enchantPoints: 4.2, slot: "Weapon", icon: "/icons/items/Glass_Staff.png" },
  "Ebony Staff": { enchantPoints: 90, slot: "Weapon", icon: "/icons/items/Ebony_Staff.png" },
  "Daedric Staff": { enchantPoints: 21, slot: "Weapon", icon: "/icons/items/Daedric_Staff.png" },
  "Chitin Dagger": { enchantPoints: 1, slot: "Weapon", icon: "/icons/items/Chitin_Dagger.png" },
  "Iron Dagger": { enchantPoints: 2, slot: "Weapon", icon: "/icons/items/Iron_Dagger.png" },
  "Chitin Shortsword": { enchantPoints: 2, slot: "Weapon", icon: "/icons/items/Chitin_Shortsword.png" },
  "Iron Tanto": { enchantPoints: 2.2, slot: "Weapon", icon: "/icons/items/Iron_Tanto.png" },
  "Steel Dagger": { enchantPoints: 2, slot: "Weapon", icon: "/icons/items/Steel_Dagger.png" },
  "Iron Shortsword": { enchantPoints: 4, slot: "Weapon", icon: "/icons/items/Iron_Shortsword.png" },
  "Iron Wakizashi": { enchantPoints: 4.5, slot: "Weapon", icon: "/icons/items/Iron_Wakizashi.png" },
  "Steel Tanto": { enchantPoints: 2.2, slot: "Weapon", icon: "/icons/items/Steel_Tanto.png" },
  "Imperial Shortsword": { enchantPoints: 5, slot: "Weapon", icon: "/icons/items/Imperial_Shortsword.png" },
  "Silver Dagger": { enchantPoints: 1.6, slot: "Weapon", icon: "/icons/items/Silver_Dagger.png" },
  "Steel Shortsword": { enchantPoints: 4, slot: "Weapon", icon: "/icons/items/Steel_Shortsword.png" },
  "Steel Wakizashi": { enchantPoints: 4.5, slot: "Weapon", icon: "/icons/items/Steel_Wakizashi.png" },
  "Silver Shortsword": { enchantPoints: 3.6, slot: "Weapon", icon: "/icons/items/Silver_Shortsword.png" },
  "Dwarven Shortsword": { enchantPoints: 4, slot: "Weapon", icon: "/icons/items/Dwarven_Shortsword.png" },
  "Glass Dagger": { enchantPoints: 1.2, slot: "Weapon", icon: "/icons/items/Glass_Dagger.png" },
  "Daedric Dagger": { enchantPoints: 6, slot: "Weapon", icon: "/icons/items/Daedric_Dagger.png" },
  "Ebony Shortsword": { enchantPoints: 8, slot: "Weapon", icon: "/icons/items/Ebony_Shortsword.png" },
  "Daedric Tanto": { enchantPoints: 6.6, slot: "Weapon", icon: "/icons/items/Daedric_Tanto.png" },
  "Daedric Shortsword": { enchantPoints: 12, slot: "Weapon", icon: "/icons/items/Daedric_Shortsword.png" },
  "Daedric Wakizashi": { enchantPoints: 13.5, slot: "Weapon", icon: "/icons/items/Daedric_Wakizashi.png" },
  "Iron Saber": { enchantPoints: 5.5, slot: "Weapon", icon: "/icons/items/Iron_Saber.png" },
  ...
  "Steel Katana": { enchantPoints: 6, slot: "Weapon", icon: "/icons/items/Steel_Katana.png" },
  "Silver Longsword": { enchantPoints: 4.8, slot: "Weapon", icon: "/icons/items/Silver_Longsword.png" },
  "Glass Longsword": { enchantPoints: 3.6, slot: "Weapon", icon: "/icons/items/Glass_Longsword.png" },
  "Ebony Broadsword": { enchantPoints: 10, slot: "Weapon", icon: "/icons/items/Ebony_Broadsword.png" },
  "Ebony Longsword": { enchantPoints: 12, slot: "Weapon", icon: "/icons/items/Ebony_Longsword.png" },
  "Daedric Longsword": { enchantPoints: 18, slot: "Weapon", icon: "/icons/items/Daedric_Longsword.png" },
  "Daedric Katana": { enchantPoints: 18, slot: "Weapon", icon: "/icons/items/Daedric_Katana.png" },
  "Iron Claymore": { enchantPoints: 7, slot: "Weapon", icon: "/icons/items/Iron_Claymore.png" },
  "Steel Claymore": { enchantPoints: 7, slot: "Weapon", icon: "/icons/items/Steel_Claymore.png" },
  "Nordic Claymore": { enchantPoints: 10, slot: "Weapon", icon: "/icons/items/Nordic_Claymore.png" },
  "Steel Dai-katana": { enchantPoints: 7, slot: "Weapon", icon: "/icons/items/Steel_Dai-katana.png" },
  "Silver Claymore": { enchantPoints: 5.6, slot: "Weapon", icon: "/icons/items/Silver_Claymore.png" },
  "Dwarven Claymore": { enchantPoints: 7, slot: "Weapon", icon: "/icons/items/Dwarven_Claymore.png" },
  Foeburner: { enchantPoints: 4, slot: "Weapon", icon: "/icons/items/Dwarven_Claymore.png" },
  "Glass Claymore": { enchantPoints: 4.2, slot: "Weapon", icon: "/icons/items/Glass_Claymore.png" },
  "Daedric Claymore": { enchantPoints: 21, slot: "Weapon", icon: "/icons/items/Daedric_Claymore.png" },
  "Daedric Dai-katana": { enchantPoints: 21, slot: "Weapon", icon: "/icons/items/Daedric_Dai-katana.png" },
  "Chitin Spear": { enchantPoints: 2.5, slot: "Weapon", icon: "/icons/items/Chitin_Spear.png" },
  "Iron Spear": { enchantPoints: 5, slot: "Weapon", icon: "/icons/items/Iron_Spear.png" },
  "Steel Spear": { enchantPoints: 5, slot: "Weapon", icon: "/icons/items/Steel_Spear.png" },
  "Iron Halberd": { enchantPoints: 5, slot: "Weapon", icon: "/icons/items/Iron_Halberd.png" },
  "Steel Halberd": { enchantPoints: 5, slot: "Weapon", icon: "/icons/items/Steel_Halberd.png" },
  "Silver Spear": { enchantPoints: 4, slot: "Weapon", icon: "/icons/items/Silver_Spear.png" },
  "Dwarven Spear": { enchantPoints: 5, slot: "Weapon", icon: "/icons/items/Dwarven_Spear.png" },
  "Dwarven Halberd": { enchantPoints: 7, slot: "Weapon", icon: "/icons/items/Dwarven_Halberd.png" },
  "Ebony Spear": { enchantPoints: 10, slot: "Weapon", icon: "/icons/items/Ebony_Spear.png" },
  "Glass Halberd": { enchantPoints: 3, slot: "Weapon", icon: "/icons/items/Glass_Halberd.png" },
  "Daedric Spear": { enchantPoints: 15, slot: "Weapon", icon: "/icons/items/Daedric_Spear.png" },
  "Chitin Short Bow": { enchantPoints: 1, slot: "Weapon", icon: "/icons/items/Chitin_Short_Bow.png" },
  "Short Bow": { enchantPoints: 2, slot: "Weapon", icon: "/icons/items/Short_Bow.png" },
  "Long Bow": { enchantPoints: 3.5, slot: "Weapon", icon: "/icons/items/Long_Bow.png" },
  "Steel Longbow": { enchantPoints: 3.5, slot: "Weapon", icon: "/icons/items/Steel_Longbow.png" },
  "Bonemold Long Bow": { enchantPoints: 40, slot: "Weapon", icon: "/icons/items/Bonemold_Long_Bow.png" },
  "Daedric Long Bow": { enchantPoints: 10.5, slot: "Weapon", icon: "/icons/items/Daedric_Long_Bow.png" },
  "Steel Crossbow": { enchantPoints: 5, slot: "Weapon", icon: "/icons/items/Steel_Crossbow.png" },
  "Dwarven Crossbow": { enchantPoints: 5, slot: "Weapon", icon: "/icons/items/Dwarven_Crossbow.png" },
  "Iron Throwing Knife": { enchantPoints: 1.5, slot: "Weapon", icon: "/icons/items/Iron_Throwing_Knife.png" },
  "Chitin Throwing Star": { enchantPoints: 0.7, slot: "Weapon", icon: "/icons/items/Chitin_Throwing_Star.png" },
  "Steel Throwing Knife": { enchantPoints: 1.5, slot: "Weapon", icon: "/icons/items/Steel_Throwing_Knife.png" },
  "Steel Dart": { enchantPoints: 1.5, slot: "Weapon", icon: "/icons/items/Steel_Dart.png" },
  "Steel Throwing Star": { enchantPoints: 1.5, slot: "Weapon", icon: "/icons/items/Steel_Throwing_Star.png" },
  "Silver Dart": { enchantPoints: 1.2, slot: "Weapon", icon: "/icons/items/Silver_Dart.png" },
  "Silver Throwing Star": { enchantPoints: 1.2, slot: "Weapon", icon: "/icons/items/Silver_Throwing_Star.png" },
  "Glass Throwing Knife": { enchantPoints: 0.9, slot: "Weapon", icon: "/icons/items/Glass_Throwing_Knife.png" },
  "Glass Throwing Star": { enchantPoints: 0.9, slot: "Weapon", icon: "/icons/items/Glass_Throwing_Star.png" },
  "Ebony Dart": { enchantPoints: 3, slot: "Weapon", icon: "/icons/items/Ebony_Dart.png" },
  "Ebony Throwing Star": { enchantPoints: 3, slot: "Weapon", icon: "/icons/items/Ebony_Throwing_Star.png" },
  "Daedric Dart": { enchantPoints: 4.5, slot: "Weapon", icon: "/icons/items/Daedric_Dart.png" },
  // Clothing (Base)
  "Common Amulet": { enchantPoints: 1, slot: "Amulet", icon: "/icons/items/Common_Amulet.png" },
  "Expensive Amulet": { enchantPoints: 15, slot: "Amulet", icon: "/icons/items/Expensive_Amulet.png" },
  ...
  "Expensive Belt": { enchantPoints: 5, slot: "Belt", icon: "/icons/items/Expensive_Belt.png" },
  "Extravagant Belt": { enchantPoints: 20, slot: "Belt", icon: "/icons/items/Extravagant_Belt.png" },
  "Exquisite Belt": { enchantPoints: 40, slot: "Belt", icon: "/icons/items/Exquisite_Belt.png" },
  ...
  "Exquisite Pants": { enchantPoints: 60, slot: "Pants", icon: "/icons/items/Exquisite_Pants.png" },
  "Common Ring": { enchantPoints: 1, slot: "Ring", icon: "/icons/items/Common_Ring.png" },
  "Expensive Ring": { enchantPoints: 15, slot: "Ring", icon: "/icons/items/Expensive_Ring.png" },
  "Extravagant Ring": { enchantPoints: 60, slot: "Ring", icon: "/icons/items/Extravagant_Ring.png" },
  "Exquisite Ring": { enchantPoints: 120, slot: "Ring", icon: "/icons/items/Exquisite_Ring.png" },
  "Common Robe": { enchantPoints: 1, slot: "Robe", icon: "/icons/items/Common_Robe.png" },
  "Expensive Robe": { enchantPoints: 5, slot: "Robe", icon: "/icons/items/Expensive_Robe.png" },
  "Extravagant Robe": { enchantPoints: 20, slot: "Robe", icon: "/icons/items/Extravagant_Robe.png" },
  "Exquisite Robe": { enchantPoints: 40, slot: "Robe", icon: "/icons/items/Exquisite_Robe.png" },
  "Common Shirt": { enchantPoints: 2, slot: "Shirt", icon: "/icons/items/Common_Shirt.png" },
  "Gondolier Shirt": { enchantPoints: 10, slot: "Shirt", icon: "/icons/items/Gondolier_Shirt.png" },
  "Expensive Shirt": { enchantPoints: 7.5, slot: "Shirt", icon: "/icons/items/Expensive_Shirt.png" },
  "Extravagant Shirt": { enchantPoints: 30, slot: "Shirt", icon: "/icons/items/Extravagant_Shirt.png" },
  "Exquisite Shirt": { enchantPoints: 60, slot: "Shirt", icon: "/icons/items/Exquisite_Shirt.png" },
  "Common Shoes": { enchantPoints: 1, slot: "Boots", icon: "/icons/items/Common_Shoes.png" },
  "Expensive Shoes": { enchantPoints: 5, slot: "Boots", icon: "/icons/items/Expensive_Shoes.png" },
  "Extravagant Shoes": { enchantPoints: 20, slot: "Boots", icon: "/icons/items/Extravagant_Shoes.png" },
  "Exquisite Shoes": { enchantPoints: 40, slot: "Boots", icon: "/icons/items/Exquisite_Shoes.png" },
  "Common Skirt": { enchantPoints: 2, slot: "Skirt", icon: "/icons/items/Common_Skirt.png" },
  "Expensive Skirt": { enchantPoints: 7.5, slot: "Skirt", icon: "/icons/items/Expensive_Skirt.png" },
  "Extravagant Skirt": { enchantPoints: 30, slot: "Skirt", icon: "/icons/items/Extravagant_Skirt.png" },
  "Exquisite Skirt": { enchantPoints: 60, slot: "Skirt", icon: "/icons/items/Exquisite_Skirt.png" },
  "Imperial Skirt": { enchantPoints: 0.5, slot: "Skirt", icon: "/icons/items/Imperial_Skirt.png" },
  "Imperial Templar Skirt": { enchantPoints: 0.5, slot: "Skirt", icon: "/icons/items/Imperial_Templar_Skirt.png" },
  // Armour (Plugins)
  "Adamantium Cuirass": { enchantPoints: 30, slot: "Cuirass", icon: "/icons/items/Adamantium_Cuirass.png" },
  "Adamantium Left Pauldron": { enchantPoints: 3, slot: "Left Pauldron", icon: "/icons/items/Adamantium_Pauldron.png" },
  "Adamantium Right Pauldron": { enchantPoints: 10, slot: "Right Pauldron", icon: "/icons/items/Adamantium_Pauldron.png" },
  "Adamantium Greaves": { enchantPoints: 3, slot: "Greaves", icon: "/icons/items/Adamantium_Greaves.png" },
  "Adamantium Boots": { enchantPoints: 10, slot: "Boots", icon: "/icons/items/Adamantium_Boots.png" },
  "Adamantium Left Bracer": { enchantPoints: 10, slot: "Left Gauntlet", icon: "/icons/items/Adamantium_Bracer.png" },
  "Adamantium Right Bracer": { enchantPoints: 10, slot: "Right Gauntlet", icon: "/icons/items/Adamantium_Bracer.png" },
  "Adamantium Helm of Tohan": { enchantPoints: 150, slot: "Helm", icon: "/icons/items/Adamantium_Helm.png" },
  "Domina Cuirass": { enchantPoints: 12, slot: "Cuirass", icon: "/icons/items/Domina_Cuirass.png" },
  "Domina Helmet": { enchantPoints: 4, slot: "Helm", icon: "/icons/items/Domina_Helmet.png" },
  "Domina Left Pauldron": { enchantPoints: 4, slot: "Left Pauldron", icon: "/icons/items/Domina_Pauldron.png" },
  "Domina Right Pauldron": { enchantPoints: 4, slot: "Right Pauldron", icon: "/icons/items/Domina_Pauldron.png" },
  "Domina Greaves": { enchantPoints: 4, slot: "Greaves", icon: "/icons/items/Domina_Greaves.png" },
  "Domina Boots": { enchantPoints: 6, slot: "Boots", icon: "/icons/items/Domina_Boots.png" },
  "Domina Left Gauntlet": { enchantPoints: 8, slot: "Left Gauntlet", icon: "/icons/items/Domina_Gauntlet.png" },
  "Domina Right Gauntlet": { enchantPoints: 8, slot: "Right Gauntlet", icon: "/icons/items/Domina_Gauntlet.png" },
  "Gold Armor Cuirass": { enchantPoints: 14, slot: "Cuirass", icon: "/icons/items/Gold_Armor_Cuirass.png" },
  "Gold Armor Helmet": { enchantPoints: 9, slot: "Helm", icon: "/icons/items/Gold_Armor_Helmet.png" },
  "Gold Armor Left Pauldron": { enchantPoints: 5, slot: "Left Pauldron", icon: "/icons/items/Gold_Armor_Pauldron.png" },
  "Gold Armor Right Pauldron": { enchantPoints: 5, slot: "Right Pauldron", icon: "/icons/items/Gold_Armor_Pauldron.png" },
  // Armour (Tribunal)
