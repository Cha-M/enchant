...
export const items: Record<string, Item> = {
  ...
  // Armour (Bloodmoon)
  "Wolf Boots": { enchantPoints: 2, slot: "Boots", icon: "/icons/items/Wolf_Boots.png" },
  "Wolf Cuirass": { enchantPoints: 6, slot: "Cuirass", icon: "/icons/items/Wolf_Cuirass.png" },
  "Wolf Greaves": { enchantPoints: 4.5, slot: "Greaves", icon: "/icons/items/Wolf_Greaves.png" },
  "Wolf Helmet": { enchantPoints: 2, slot: "Helm", icon: "/icons/items/Wolf_Helmet.png" },
  "Wolf Left Gauntlet": { enchantPoints: 1, slot: "Left Gauntlet", icon: "/icons/items/Wolf_Gauntlet.png" },
  "Wolf Right Gauntlet": { enchantPoints: 1, slot: "Right Gauntlet", icon: "/icons/items/Wolf_Gauntlet.png" },
  "Wolf Left Pauldron": { enchantPoints: 1.6, slot: "Left Pauldron", icon: "/icons/items/Wolf_Pauldron.png" },
  "Wolf Right Pauldron": { enchantPoints: 1.6, slot: "Right Pauldron", icon: "/icons/items/Wolf_Pauldron.png" },
  "Wolf Shield": { enchantPoints: 5, slot: "Shield", icon: "/icons/items/Wolf_Shield.png" },
  "Riekling Shield": { enchantPoints: 8, slot: "Shield", icon: "/icons/items/Riekling_Shield.png" },
  "Bear Boots": { enchantPoints: 2, slot: "Boots", icon: "/icons/items/Bear_Boots.png" },
  "Bear Cuirass": { enchantPoints: 6, slot: "Cuirass", icon: "/icons/items/Bear_Cuirass.png" },
  "Bear Greaves": { enchantPoints: 4.5, slot: "Greaves", icon: "/icons/items/Bear_Greaves.png" },
  "Bear Helmet": { enchantPoints: 2, slot: "Helm", icon: "/icons/items/Bear_Helmet.png" },
  "Bear Left Gauntlet": { enchantPoints: 1, slot: "Left Gauntlet", icon: "/icons/items/Bear_Gauntlet.png" },
  "Bear Right Gauntlet": { enchantPoints: 1, slot: "Right Gauntlet", icon: "/icons/items/Bear_Gauntlet.png" },
  "Bear Left Pauldron": { enchantPoints: 1.6, slot: "Left Pauldron", icon: "/icons/items/Bear_Pauldron.png" },
  "Bear Right Pauldron": { enchantPoints: 1.6, slot: "Right Pauldron", icon: "/icons/items/Bear_Pauldron.png" },
  "Bear Shield": { enchantPoints: 2, slot: "Shield", icon: "/icons/items/Bear_Shield.png" },
  "Ice Armor Boots": { enchantPoints: 10, slot: "Boots", icon: "/icons/items/Ice_Armor_Boots.png" },
  "Ice Armor Cuirass": { enchantPoints: 18, slot: "Cuirass", icon: "/icons/items/Ice_Armor_Cuirass.png" },
  "Ice Armor Greaves": { enchantPoints: 10, slot: "Greaves", icon: "/icons/items/Ice_Armor_Greaves.png" },
  "Ice Armor Helmet": { enchantPoints: 17.5, slot: "Helm", icon: "/icons/items/Ice_Armor_Helmet.png" },
  "Ice Armor Left Gauntlet": { enchantPoints: 10, slot: "Left Gauntlet", icon: "/icons/items/Ice_Armor_Gauntlet.png" },
  "Ice Armor Right Gauntlet": { enchantPoints: 10, slot: "Right Gauntlet", icon: "/icons/items/Ice_Armor_Gauntlet.png" },
  "Ice Armor Left Pauldron": { enchantPoints: 1.8, slot: "Left Pauldron", icon: "/icons/items/Ice_Armor_Pauldron.png" },
  "Ice Armor Right Pauldron": { enchantPoints: 1.8, slot: "Right Pauldron", icon: "/icons/items/Ice_Armor_Pauldron.png" },
  "Ice Shield": { enchantPoints: 40, slot: "Shield", icon: "/icons/items/Ice_Shield.png" },
  "Nordic Mail Boots": { enchantPoints: 8.5, slot: "Boots", icon: "/icons/items/Nordic_Mail_Boots.png" },
  "Nordic Mail Cuirass": { enchantPoints: 30, slot: "Cuirass", icon: "/icons/items/Nordic_Mail_Cuirass.png" },
  "Nordic Mail Greaves": { enchantPoints: 8, slot: "Greaves", icon: "/icons/items/Nordic_Mail_Greaves.png" },
  "Nordic Mail Helmet": { enchantPoints: 20, slot: "Helm", icon: "/icons/items/Nordic_Mail_Helmet.png" },
  "Nordic Mail Left Gauntlet": { enchantPoints: 10, slot: "Left Gauntlet", icon: "/icons/items/Nordic_Mail_Gauntlet.png" },
  "Nordic Mail Right Gauntlet": { enchantPoints: 10, slot: "Right Gauntlet", icon: "/icons/items/Nordic_Mail_Gauntlet.png" },
  "Nordic Mail Left Pauldron": { enchantPoints: 10, slot: "Left Pauldron", icon: "/icons/items/Nordic_Mail_Pauldron.png" },
  "Nordic Mail Right Pauldron": { enchantPoints: 10, slot: "Right Pauldron", icon: "/icons/items/Nordic_Mail_Pauldron.png" },
  "Nordic Mail Shield": { enchantPoints: 10, slot: "Shield", icon: "/icons/items/Nordic_Mail_Shield.png" },
  // Weapons (Bloodmoon)
