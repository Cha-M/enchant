...
export const items: Record<string, Item> = {
  ...
  // Weapons (Bloodmoon)
  "Huntsman Axe": { enchantPoints: 5, slot: "Weapon", icon: "/icons/items/Huntsman_Axe.png" },
  "Huntsman War Axe": { enchantPoints: 5, slot: "Weapon", icon: "/icons/items/Huntsman_War_Axe.png" },
  ...
  "Huntsman Spear": { enchantPoints: 8.5, slot: "Weapon", icon: "/icons/items/Huntsman_Spear.png" },
  // Clothing (Bloodmoon)
