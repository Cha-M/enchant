...
export const items: Record<string, Item> = {
  ...
  "Ice Armor Boots": { enchantPoints: 10, slot: "Boots", icon: "/icons/items/Ice_Boots.png" },
  "Ice Armor Cuirass": { enchantPoints: 18, slot: "Cuirass", icon: "/icons/items/Ice_Cuirass.png" },
  "Ice Armor Greaves": { enchantPoints: 10, slot: "Greaves", icon: "/icons/items/Ice_Greaves.png" },
  "Ice Armor Helmet": { enchantPoints: 17.5, slot: "Helm", icon: "/icons/items/Ice_Helmet.png" },
  "Ice Armor Left Gauntlet": { enchantPoints: 10, slot: "Left Gauntlet", icon: "/icons/items/Ice_Gauntlet.png" },
  "Ice Armor Right Gauntlet": { enchantPoints: 10, slot: "Right Gauntlet", icon: "/icons/items/Ice_Gauntlet.png" },
  "Ice Armor Left Pauldron": { enchantPoints: 1.8, slot: "Left Pauldron", icon: "/icons/items/Ice_Pauldron.png" },
  "Ice Armor Right Pauldron": { enchantPoints: 1.8, slot: "Right Pauldron", icon: "/icons/items/Ice_Pauldron.png" },
