...
export const items: Record<string, Item> = {
  ...
  "Her Hand's Helmet": { enchantPoints: 65, slot: "Helm" },
  "Her Hand's Cuirass": { enchantPoints: 55, slot: "Cuirass" },
  "Her Hand's Left Pauldron": { enchantPoints: 5, slot: "Left Pauldron" },
  "Her Hand's Right Pauldron": { enchantPoints: 5, slot: "Right Pauldron" },
  "Her Hand's Greaves": { enchantPoints: 6, slot: "Greaves" },
  "Her Hand's Boots": { enchantPoints: 20, slot: "Boots" },
  "Her Hand's Left Gauntlet": { enchantPoints: 50, slot: "Left Gauntlet" },
  "Her Hand's Right Gauntlet": { enchantPoints: 50, slot: "Right Gauntlet" },
  "Her Hand's Shield": { enchantPoints: 50, slot: "Shield" },
  // Weapons (Tribunal)
